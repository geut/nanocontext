...
Fork the project [on GitHub](https://github.com/geut/nanocontext) and check out your copy locally.

```bash
$ git clone git@github.com:username/nanocontext.git
$ cd nanocontext
$ npm install
$ git remote add upstream git://github.com/geut/nanocontext.git
```
